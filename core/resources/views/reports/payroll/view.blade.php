...
<body>
    ...
    <div class="card p-0 m-0" style="width: 100%; height:100%">
        <div class="card-header">
            <img src="{{ asset('assets/img/logo-slip.jpg') }}" alt="Logo" width="30%" height="auto">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <h5 class="pt-3"><strong>DAFTAR PRESENSI KARYAWAN</strong></h5>
            </div>
            <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div class="table-responsive text-nowrap">
                <table class="table" id="dataTable">
                    <thead class="table-bordered">
                        <tr>
                            <th rowspan="3" class="text-center" style="vertical-align: middle;" width="15%">Nama
                            </th>
                        ...
                        <tr>
                            @foreach ($dates as $index => $date)
                                <th class="p-0 text-center border">{{ \Carbon\Carbon::parse($date)->format('d') }}</th>
                            @endforeach
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <table class="table table-bordered table-sm text-center">
                            ...
                            <tbody>
                                @php
                                    $l = 1;
                                    $tlh = 0;
                                    $rates = (float) \App\Models\Settings::getVal('tarif_lembur') ?? 0;
                                @endphp
                                @foreach ($overtimes as $ovt)
                                    <tr>
                                        ...
                                        <td>{{ $ovt->date }}</td>
                                        <td>{{ $ovt->hours }} Jam</td>
                                        <td class="amount">{{ $ovt->hours * $rates }}</td>
                                    </tr>
                                    @php
                                        $tlh += $ovt->hours;
                                    @endphp
                                ...
                                <tr>
                                    ...
                                    <td>{{ $tlh }} Jam</td>
                                    <td class="amount">{{ $tlr = $tlh * $rates }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
