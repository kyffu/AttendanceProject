...
<body>
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                Satelyte | Smart Integrated Payroll Systems
                            </div>
                        </div>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="https://ui-avatars.com/api/?bold=true&background=random&color=ffffff&?rounded=true&name={{ Auth::user()->name }}"
                                            alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="{{route('user.detail', Crypt::encryptString(Auth::user()->id))}}}">
    ...
    <script src="{{ asset('vendor/datatables/responsive.bootstrap5.js') }}"></script>
